  ...
  return (
    ...
    <div className="md:flex  md:m-8   items-center ">
        ...
        <div className="md:ml-0 md:mb-56 md:w-[447px] md:h-[168px] w-[300px] h-[160px] mx-auto">
            ...
            <h1 className="text-center md:mt-12 mt-4  ml-16 md:ml-0 rounded-3xl p-5   text-white bg-orange-600 md:bg-blue-600  w-[175px] h-[52px] font-roboto font-medium text-xs">SIGN UP NOW</h1>
        </div>
